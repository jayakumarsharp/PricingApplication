ReportApp.controller("DaySheetController", ['$rootScope', '$scope', '$routeParams', '$window', '$http', 'priceService', 'currencyService', 'Opportunityservice', '$timeout', 'toaster', '$location', 'reportFactory', 'DayService', 'paymentConfigFactory', '_', 'EstimationApplicationMasterService', 'ManualEstimationMasterService', 'ManualEstimationTypeService', 'UserFactory', 'EstimationSDLCResourceService', 'OpportunityRateService', 'TandEPSService', '$filter', 'paymentService', 'GrossMarginService',
    'TandEResourceService', 'ResourceService', 'OppFactory', 'ProjectMarginAdminFactory', function ($rootScope, $scope, $routeParams, $window, $http, priceService, currencyService, Opportunityservice, $timeout, toaster, $location, reportFactory, DayService, paymentConfigFactory, _, EstimationApplicationMasterService, ManualEstimationMasterService, ManualEstimationTypeService, UserFactory, EstimationSDLCResourceService, OpportunityRateService, TandEPSService, $filter, paymentService, GrossMarginService,
        ...
        $scope.PageVariableInitialization_Daysheet = function () {
            ...
            $scope.ExtendedEffortCycle = { REQ: 1, Design: 1, DevTest: 1, SysTest: 1, IMPL: 1, UAT: 1, PROD: 1, Train: 1, Manual: 1, OH: 1, SQA: 1, PM: 1, DaySheetGroupId: $scope.MaxSheetGroupID };
            ...
            $scope.TEtabs = [{ title: 'PS', active: true, GridName: 'tandEPSGrd' }, { title: 'T & E Resources', active: false, GridName: 'tandEResourceGrid' }];

            $scope.tabs = [
                { title: 'Estimation Sheet Version Selection', active: true, GridName: '--' },
                { title: 'Day Sheet', active: false, GridName: 'gridExtendedEffortTool' },
                { title: 'Detailed view', active: false, GridName: 'gridLOB' },
                { title: 'FTE Hours/Days and Business Days', active: false, GridName: 'gridFTEDays' },
            ];

            $scope.tabs1 = [
                { title: 'Opportunity Configuration', active: true, GridName: '--' },
                { title: 'Resourcing', active: false, GridName: 'resourceGrid' },
                { title: 'T & E', active: false, GridName: 'tandEPSGrd' },
                { title: 'Estimation - PS', active: false, GridName: 'Estimation' },
                { title: 'Pricing Sheet', active: false, GridName: 'gridOptions_PriceList' },
                { title: 'Payment Sheet', active: false, GridName: 'gridPayment' },
                { title: 'Project Margin', active: false, GridName: '--' }
            ];
            //start
            ...
            $scope.select = function (tab, type) {
                ...
                if (type == 1) {  //Estimation Sub tabs
                    ...
                    $timeout(function () {
                        if (tab.GridName == "gridExtendedEffortTool") {
                            $scope.gridExtendedEffortTool.api.sizeColumnsToFit();
                            $scope.gridExtendedEffortManual.api.sizeColumnsToFit();
                            $scope.gridExtendedEffortAdditional.api.sizeColumnsToFit();
                            $scope.gridExtendedEffortTool.api.refreshView();
                            $scope.gridExtendedEffortManual.api.refreshView();
                            $scope.gridExtendedEffortAdditional.api.refreshView();
                        }
        ...
        $scope.ExtendedEffortFromTooldata = [];
        $scope.gridExtendedEffortManualdata = [];
        $scope.gridExtendedEffortAdditionaldata = [];
        $scope.gridCalculatedEffortdata = [];
        $scope.dataLOB = [];

        $scope.gridExtendedEffortTool = {
            angularCompileRows: true,
            columnDefs: [],
            rowSelection: 'single',
            headerHeight: 38,
            rowHeight: 25,
            rowData: $scope.ExtendedEffortFromTooldata,
            enableColResize: true,
            groupSuppressAutoColumn: false,
            groupSuppressGroupColumn: true,
            suppressMovableColumns: true,
        ...
        $scope.gridExtendedEffortManual = {
            angularCompileRows: true,
            columnDefs: [],
            rowSelection: 'single',
            headerHeight: 38,
            rowHeight: 25,
            rowData: $scope.gridExtendedEffortManualdata,
            enableColResize: true,
            groupSuppressAutoColumn: false,
            groupSuppressGroupColumn: true,
            suppressMovableColumns: true,
        ...
        $scope.gridExtendedEffortAdditional = {
            angularCompileRows: true,
            columnDefs: [],
            rowSelection: 'single',
            headerHeight: 38,
            rowHeight: 25,
            rowData: $scope.gridExtendedEffortAdditionaldata,
            enableColResize: true,
            groupSuppressAutoColumn: false,
            groupSuppressGroupColumn: true,
            suppressMovableColumns: true,
        ...
        $scope.gridCalculatedEffort = {
            angularCompileRows: true,
            columnDefs: [],
            rowSelection: 'single',
            headerHeight: 38,
            rowHeight: 25,
            rowData: $scope.gridCalculatedEffortdata,
            enableColResize: true,
            groupSuppressAutoColumn: false,
            groupSuppressGroupColumn: true,
            suppressMovableColumns: true,
        ...
        $scope.onchangedatacenter = function () {
            var test = {
                OppId: $scope.OpportunityDetail.id, RootId: $scope.MaxSheetGroupID,
        ...
        $scope.getdata = function () {
            ...
            $timeout(function () {
                ...
                $scope.gridExtendedEffortManual.api.sizeColumnsToFit();
                $scope.gridExtendedEffortAdditional.api.sizeColumnsToFit();
                $scope.gridCalculatedEffort.api.sizeColumnsToFit();

                $scope.gridExtendedEffortTool.api.refreshView();
                $scope.gridExtendedEffortManual.api.refreshView();
                $scope.gridExtendedEffortAdditional.api.refreshView();
                $scope.gridCalculatedEffort.api.refreshView();
                angular.element(document.querySelector('#loader')).addClass('hide');
            }, 3000);
        ...
        $scope.GetOpportunityList = function (id, iseditclick) {
        ...
        function setgrid() {
            ...
            var columnDefs1 = [
                    ...
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" max-length="50" ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].Description"'
                                + '/></span>';
                        }
                        else
                            return $scope.gridExtendedEffortAdditionaldata[params.rowIndex].Description;
                    },
                },
                {
                    headerName: "REQ", field: "REQ", width: 70, headerTooltip: "REQ",
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].REQ" ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].REQ, 1);
                    },
                },
                {
                    headerName: "Design", field: "Design", width: 70, headerTooltip: "Design",
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + ' type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].Design" ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].Design, 1);
                    },
                },
                {
                    headerName: "DevTest", field: "DevTest", width: 70,
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[ ' + params.rowIndex + '].DevTest"  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].DevTest, 1);
                    },
                },
                {
                    headerName: "SysTest", field: "SysTest", width: 70,
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].SysTest"  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].SysTest, 1);
                    },
                },
                {
                    headerName: "IMPL", field: "IMPL", width: 70,
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].IMPL "  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].IMPL, 1);
                    },
                },
                {
                    headerName: "UAT", field: "UAT", width: 70,
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].UAT "  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].UAT, 1);
                    },
                },
                {
                    headerName: "PROD", field: "PROD", width: 70,
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].PROD "  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].PROD, 1);
                    },
                },
                {
                    headerName: "TRAIN", field: "TRAIN", width: 70,
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].TRAIN "  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].TRAIN, 1);
                    },
                ...
                },
                {
                    ...
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].MANUAL "  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].MANUAL, 1);
                    },
                ...
                },
                {
                    ...
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].OH "  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].OH, 1);
                    },
                ...
                },
                {
                    ...
                    cellRenderer: function (params) {
                        if (params.data.Description != "Additional Phases") {
                            return '<span><input  ng-disabled="!isEditClicked"'
                                + 'type="text" numberonly min=0 ng-model="gridExtendedEffortAdditionaldata[' + params.rowIndex + '].SQA"  ng-blur="cellValueChangedFunction3()"'
                                + '/></span>';
                        }
                        else
                            return $filter('number')($scope.gridExtendedEffortAdditionaldata[params.rowIndex].SQA, 1);
                    },
            ...
            var columnDefsFTE = [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            headerName: "Manual", field: "Manual", editable: $scope.isEditClicked, width: 80, cellRenderer: function (params) {
                                var cssclass = "";
                                if (params.data.SDLCStage == "Project Management")
                                    cssclass = "PMgreat";
                                if (params.value > 0)
                                    return '<span class="' + cssclass + '" title=' + params.value + '>' + $filter('number')(params.value, 1) + '</span>';
                                else
                                    return '<span class="' + cssclass + '" title=' + params.value + '>' + params.value + '</span>';
                            },
                            onCellValueChanged: function (params) {
                                if (params.newValue == "") {
                                    ...
                                    if (params.data.SDLCStage == "Project Management") {
                                        params.data.Manual = params.newValue;
                                    }
                                    else {
                                        params.data.Manual = params.oldValue;
                                        toaster.pop('warning', "Warning", 'Only PM Manual value is allowed to change', null);
                                    }
                                }
                            }
                        },
                        ...
                        { headerName: "Change", field: "Change", editable: $scope.isEditClicked, width: 80 },
                        {
                ...
                },
                {
                    ...
                    children: [
                        { headerName: "Resources", field: "Resources", editable: $scope.isEditClicked, width: 80 },
                        {
                        ...
                        { headerName: "Change", field: "Daychange", editable: $scope.isEditClicked, width: 80 },
                        {
                ...
                },
                {
                    headerName: "", field: "BDChangeStatus", hide: true, cellRenderer: function (params) {
                        if (params.data.Daychange == "" || params.data.SDLCStage == "Manuals" || params.data.SDLCStage == "Orientation & Handover " || params.data.SDLCStage == "SQA" || params.data.SDLCStage == "Project Management")
                            return "Y";
                        else {
            ...
            var ResourceAllocationGridColumnDefs = [
                {
                    headerName: "Distribution By Resource Type", field: "SDLCStage", width: 150
                },
                {
                    headerName: 'BU % Onsite',
                    children: [{ headerName: "L1", field: "BUOnsiteL1", editable: $scope.isEditClicked, width: 80 },
                    { headerName: "L2", field: "BUOnsiteL2", width: 80, editable: $scope.isEditClicked }]
                },
                {
                    headerName: 'BU % Remote',
                    children: [{ headerName: "L1", field: "BURemoteL1", width: 80, editable: $scope.isEditClicked },
                    { headerName: "L2", field: "BURemoteL2", width: 80, editable: $scope.isEditClicked }]
                },
                {
                    headerName: 'CDO % Onsite',
                    children: [{ headerName: "L1", field: "CDOOnsiteL1", width: 80, editable: $scope.isEditClicked },
                    { headerName: "L2", field: "CDOOnsiteL2", width: 80, editable: $scope.isEditClicked }]
                },
                {
                    headerName: 'CDO % Remote',
                    children: [{ headerName: "L1", field: "CDORemoteL1", width: 80, editable: $scope.isEditClicked },
                    { headerName: "L2", field: "CDORemoteL2", width: 80, editable: $scope.isEditClicked }]
                },
                {
                    headerName: "Total", field: "Total", width: 150
                    , cellRenderer: function (params) {
                        params.value = (isNaN(parseFloat(params.data.BUOnsiteL1)) ? 0 : parseFloat(params.data.BUOnsiteL1)) +
                    ...
                    cellClassRules: {
                        'bg-red': function (params) {
                            var value = (isNaN(parseFloat(params.data.BUOnsiteL1)) ? 0 : parseFloat(params.data.BUOnsiteL1)) +
                                (isNaN(parseFloat(params.data.BUOnsiteL2)) ? 0 : parseFloat(params.data.BUOnsiteL2)) +
                                (isNaN(parseFloat(params.data.BURemoteL1)) ? 0 : parseFloat(params.data.BURemoteL1)) +
                                (isNaN(parseFloat(params.data.BURemoteL2)) ? 0 : parseFloat(params.data.BURemoteL2)) +
                                (isNaN(parseFloat(params.data.CDOOnsiteL1)) ? 0 : parseFloat(params.data.CDOOnsiteL1)) +
            ...
            $scope.gridExtendedEffortTool.api.setColumnDefs(columnDefs);
            $scope.gridExtendedEffortManual.api.setColumnDefs(columnDefs);
            $scope.gridExtendedEffortAdditional.api.setColumnDefs(columnDefs1);
            $scope.gridCalculatedEffort.api.setColumnDefs(columnDefs);
            ...
            priceCostGridColumnDefs[2].headerName = 'FTE ' + $scope.OpportunityDetail.UseManDayshours;
            $scope.gridFTEDays.api.setColumnDefs(columnDefsFTE);
            $scope.gridDistribution.api.setColumnDefs(ResourceAllocationGridColumnDefs);
            $scope.gridPriceCost.api.setColumnDefs(priceCostGridColumnDefs);
        }
        ...
        function ReverseCalc() {
            ...
            if ($scope.GlobalVersionsave.length > 0) {
                ...
                $scope.DaySheetData.ManualId = dodeepdivepluck("MANUAL");
            }
        }
        ...
        $scope.GetDaySheetbyOppGroup = function (oppid, groupid) {
            DayService.GetDaySheetbyOppGroup(oppid, groupid).success(function (data) {
                ...
                //jay midd
                $scope.ExtendedEffortFromTooldata = _.filter($scope.DaysheetPMData, function (obj) {
                    return obj.GridName == "EffortFromTool";
                });

                $scope.gridExtendedEffortManualdata = _.filter($scope.DaysheetPMData, function (obj) {
                    return obj.GridName == "EffortFromManual";
                });
                $scope.gridExtendedEffortAdditionaldata = _.filter($scope.DaysheetPMData, function (obj) {
                    return obj.GridName == "ExtendedEffort";
                });
                $scope.gridCalculatedEffortdata = _.filter($scope.DaysheetPMData, function (obj) {
                    return obj.GridName == "CalculatedEffort";
                });
                $scope.dataLOB = _.filter($scope.DaysheetPMData, function (obj) {
                    return obj.GridName == "EffortFromToolLOB";
                });
                setgrid();
                $scope.gridLOB.api.setRowData($scope.dataLOB);
                $scope.gridExtendedEffortTool.api.setRowData($scope.ExtendedEffortFromTooldata);
                $scope.gridExtendedEffortManual.api.setRowData($scope.gridExtendedEffortManualdata);
                $scope.gridExtendedEffortAdditional.api.setRowData($scope.gridExtendedEffortAdditionaldata);
                $scope.gridCalculatedEffort.api.setRowData($scope.gridCalculatedEffortdata);
            ...
            DayService.GetDaysheetFTEHoursbyOppGroup($scope.OppId, $scope.MaxSheetGroupID).success(function (inputs) {
                if (inputs.length > 0) {
                    $scope.FixedFTEDaysJson = [];
            ...
            DayService.GetDaysheetExtendedEffortbyOppGroup($scope.OppId, $scope.MaxSheetGroupID).success(function (inputs) {
                if (inputs.length > 0) {
                    $scope.ExtendedEffortCycle = {};
            ...
            DayService.GetDaysheetResourceDistributionbyOppGroup($scope.OppId, $scope.MaxSheetGroupID).success(function (inputs) {
                if (inputs.length > 0) {
                    $scope.FixedDistributionJson = [];
            ...
            DayService.GetDaysheetPriceCostbyOppGroup($scope.OppId, $scope.MaxSheetGroupID).success(function (inputs) {
                if (inputs.length > 0) {
                    $scope.FixedPriceCostJson = [];
        ...
        function FindProjectComplexity() {
            ...
            ManualIMPLPStotal = 0;
            ManualOtherStotal = 0;
            _.each($scope.ExtendedEffortFromTooldata, function (value, key) {
            ...
            _.each($scope.gridExtendedEffortManualdata, function (value, key) {
                if (value['Description'] == 'SELF_SERVICE' || value['Description'] == 'APPLICATIONS' || value['Description'] == 'ADMIN' || value['Description'] == 'PACKAGE' || value['Description'] == 'REPORT')
            ...
            if ($scope.ManualEstimationdata != null && $scope.ManualEstimationdata.length > 0) {
                ...
                var byDescription = _.chain($scope.ManualEstimationdata).map(function (item) {
                    return { Description: item.Description, Total: item.Total };
                }).groupBy('Description').map(function (value, key) {
                ...
                var resultciscoManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Cisco";
                });
                ...
                var resultcisco = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultAvaya = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultavayaManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Avaya";
                });
                ...
                var resultServProduct = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultServProductManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Servion Products";
                });
                ...
                var resultAcq = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultAcqManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Acqueon";
                });

                if (resultAcqManual.length > 0) {
                    OEMOtherTotalvalue += resultAcqManual[0].Total;
                }
                var resultEgain = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultEgainManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Egain";
                });
                ...
                var resultWFO = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultWFOManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "WFO";
                });
                ...
                var resultOther = _.filter($scope.TotalSection, function (obj) {
                    return obj.ProductName == "Others";
                });
                ...
                var resultOthersManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "OthersWFO";
                });
                ...
                var resultself = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultApp = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultPack = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultAdmin = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultReport = _.filter($scope.TotalSection, function (obj) {
                ...
                var resultSSManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Self Service";
                });
                if (resultSSManual.length > 0) {
                    OEMOAppsvalue += resultSSManual[0].Total;
                }

                var resultCustomManual = _.filter(byDescription, function (obj) {
                    return obj.Description == "Custom PS";
                });
        ...
        function getselectedversionsSinglecolvalues(groupId) {
            var result1 = _.filter($scope.CompleteResultsetSingle, function (obj) {
                return obj.GroupId == groupId && obj.Section != "Total";
            });
            return result1;
        }

        function getselectedversionsMulticolvalues(groupId) {
            var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                return obj.GroupId == groupId && obj.Section != "Total";
            });
            return result1;
        }
        ...
        function getselectedversionsSinglecolvaluesTotalSectionForAdminReportDifferentPackage(groupId, area) {
            var result1 = _.filter($scope.CompleteResultsetSingle, function (obj) {
                return obj.GroupId == groupId && obj.Section != "Total" && obj.Section == area;
            });
            return result1;
        }
        ...
        function getselectedversionsSinglecolvaluesTotalSectionForAdminReportDifferent(groupId, area) {
            var result1 = _.filter($scope.CompleteResultsetSingle, function (obj) {
                return obj.GroupId == groupId && obj.Section != "Total" && obj.Section != "ADMIN" && obj.Section != "PACKAGE";
            });
            return result1;
        }
        ...
        function FillrightdataforLOB() {
            ...
            if ($scope.DaySheetData.SelfserviceId != null && parseInt($scope.DaySheetData.SelfserviceId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.SelfVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.SelfserviceId[i];
                    });
            ...
            if ($scope.DaySheetData.ApplicationsId != null && parseInt($scope.DaySheetData.ApplicationsId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.AppVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.ApplicationsId[i];
                    });
            ...
            if ($scope.DaySheetData.AdminId != null && parseInt($scope.DaySheetData.AdminId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.AdminVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.AdminId[i];
                    });
                    ...
                    var result3 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'ADMIN';
                    });
                    var AdminRow = doeachcalcultaion(result3, 'ADMIN');
                    AdminRow.Description += " - " + resultapp[0].Version;
                    singleresultrow.push(AdminRow);
                    var result4 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'PACKAGE';
                    });
                    var AdminRow1 = doeachcalcultaion(result4, 'PACKAGE');
                    AdminRow1.Description += " - " + resultapp[0].Version;
                    singleresultrow.push(AdminRow1);

                    var result5 = _.filter(currentdata, function (obj) {
                        return obj.Section != 'ADMIN' && obj.Section != 'PACKAGE' && obj.Section != 'Total';
                    });
            ...
            if ($scope.DaySheetData.CiscoId != null && parseInt($scope.DaySheetData.CiscoId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.CSVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.CiscoId[i];
                    });
                    ...
                    for (var j = 0; j < redlen; j++) {
                        var result3 = _.filter(result4, function (obj) {
                            return obj.Section == reducedArray[j];
                        })
            ...
            if ($scope.DaySheetData.ServProductsId != null && parseInt($scope.DaySheetData.ServProductsId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.ServPoductVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.ServProductsId[i];
                    });
                    ...
                    var redlen = reducedArray.length;
                    for (var j = 0; j < redlen; j++) {
                        var result3 = _.filter(result5, function (obj) {
                            return obj.Section == reducedArray[j];
                        })
            ...
            if ($scope.DaySheetData.AvayaId != null && parseInt($scope.DaySheetData.AvayaId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.AVVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.AvayaId[i];
                    });
                    var model = { NumberofApp: resultapp[0].NumberOfApplication, TotalRow: result, ProductName: 'Avaya' }
                    var currentdata = dointernalpercentagecalculationForCiscoGroup(model);
                    var result6 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'Total';
                    });
                    ...
                    var redlen = reducedArray.length;
                    for (var j = 0; j < redlen; j++) {
                        var result3 = _.filter(result6, function (obj) {
                            return obj.Section == reducedArray[j];
                        })
            ...
            if ($scope.DaySheetData.EgainId != null && parseInt($scope.DaySheetData.EgainId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.EGVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.EgainId[i];
                    });
                    ...
                    var result7 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'Total';
                    });
                    ...
                    var redlen = reducedArray.length;
                    for (var j = 0; j < redlen; j++) {
                        var result3 = _.filter(result7, function (obj) {
                            return obj.Section == reducedArray[j];
                        })
            ...
            if ($scope.DaySheetData.WFOId != null && parseInt($scope.DaySheetData.WFOId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.WFVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.WFOId[i];
                    });
                    var model = { NumberofApp: resultapp[0].NumberOfApplication, TotalRow: result, ProductName: 'WFO' }
                    var currentdata = dointernalpercentagecalculationForEgainGroup(model);
                    var result8 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'Total';
                    });
                    ...
                    var redlen = reducedArray.length;
                    for (var j = 0; j < redlen; j++) {
                        var result3 = _.filter(result8, function (obj) {
                            return obj.Section == reducedArray[j];
                        })
            ...
            if ($scope.DaySheetData.OthersId != null && parseInt($scope.DaySheetData.OthersId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.OtherVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.OthersId[i];
                    });
            ...
            if ($scope.DaySheetData.AcqueonId != null && parseInt($scope.DaySheetData.AcqueonId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var resultapp = _.filter($scope.ACQVersions, function (obj) {
                        return obj.ApplicationId == $scope.DaySheetData.AcqueonId[i];
                    });
                    var model = { NumberofApp: resultapp[0].NumberOfApplication, TotalRow: result, ProductName: 'ACQUEON' }
                    var currentdata = dointernalpercentagecalculationForCiscoGroup(model);
                    var result10 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'Total';
                    });
                    ...
                    var redlen = reducedArray.length;
                    for (var j = 0; j < redlen; j++) {
                        var result3 = _.filter(result10, function (obj) {
                            return obj.Section == reducedArray[j];
                        })
        ...
        function doeachcalcultaionForLOB(result, area, Section) {
            ...
            if (area == "ACQUEON") {
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == Section && obj.ProductName == 'ACQUEON';
                });
                if (result1.length > 0) {
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == Section && obj.ProductName == 'SERVION_PRODUCTS';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == Section && obj.ProductName == 'Avaya';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
            ...
            if (area == "eGain") {
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == Section && obj.ProductName == 'eGain';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == Section && obj.ProductName == 'WFO';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == Section && obj.ProductName == 'CISCO';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
        ...
        function GetManualEstimationdata() {
            ...
            for (var i = 0; i < manualoptlen; i++) {
                ...
                var result3 = _.filter(data, function (obj) {
                    return obj.Description == $scope.Manualoptions[i];
                })
                if (result3.length > 0) {
            ...
            for (var i = 0; i < contructjsonlen; i++) {
                ...
                if (contructjson[i].Description == "Self Service" || contructjson[i].Description == "Custom PS") {
                    ...
                    if (contructjson[i].Description == "Self Service") {
                        EstSDLCDetail = _.filter($scope.SDLCPercentage, function (obj) {
                            return obj.ProductName == "SELF_SERVICE";
                        });
                    }
                    ...
                    var EstSDLCDetail = _.filter($scope.SDLCPercentage, function (obj) {
                        return obj.ProductName.toLowerCase() == contructjson[i].Description.toLowerCase();
                    });
            ...
            $scope.gridExtendedEffortManual.rowData = $scope.gridExtendedEffortManualdata = calculation;
            $scope.gridExtendedEffortManual.api.setRowData(calculation);
        }
        ...
        function DoAdditionalEstimationdata() {
            ...
            $scope.gridExtendedEffortAdditionaldata = DefaultFourrows;
            $scope.gridExtendedEffortAdditional.rowData = DefaultFourrows;
            $scope.gridExtendedEffortAdditional.api.setRowData(DefaultFourrows);
        }
        ...
        function Fillrightdata() {
            ...
            if ($scope.DaySheetData.SelfserviceId != null && parseInt($scope.DaySheetData.SelfserviceId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    // var result1 = _.filter(currentdata, function (obj) {
                    //     return obj.Section == 'Total';
                    // });
            ...
            if ($scope.DaySheetData.ApplicationsId != null && parseInt($scope.DaySheetData.ApplicationsId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var currentdata = dointernalpercentagecalculation(model);
                    // var result2 = _.filter(currentdata, function (obj) {
                    //     return obj.Section == 'Total';
                    // });
                    consrow = consrow.concat(currentdata);
                }
            ...
            if ($scope.DaySheetData.AdminId != null && parseInt($scope.DaySheetData.AdminId.length) > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    var currentdata = dointernalpercentagecalculationForAdminReport(model);
                    var resultfilter1 = _.filter(currentdata, function (obj) {
                        return obj.Section == 'ADMIN';
                    });
                    ...
                    var resultfilter2 = _.filter(currentdata2, function (obj) {
                        return obj.Section == 'PACKAGE';
                    });
                    ...
                    var resultfilter3 = _.filter(currentdata3, function (obj) {
                        return obj.Section != 'ADMIN' && obj.Section != 'PACKAGE' && obj.Section != 'Total';
                    });
            ...
            for (var i = 0; i < lenopt; i++) {
                var resultset = _.filter(singleresultrow, function (obj) {
                    return obj.Product == $scope.options[i];
                });
                if (resultset.length > 0) {
                    $scope.ExtendedEffortFromTooldata.push({
        ...
        function doeachcalcultaion(result, area) {
            var internalcalc = {
                Description: area, REQ: 0, Design: 0, DevTest: 0, SysTest: 0, IMPL: 0, UAT: 0, PROD: 0, TRAIN: 0, MANUAL: 0, OH: 0, SQA: 0, PM: 0, Product: area, Total: 0
            }
            _.each(result, function (value, key) {
                if (value.SDLC_Type == 'Requirements_Gathering' || value.SDLC_Type == 'Requirements')
                    internalcalc.REQ += parseFloat(value.ResultProdPercentage);
            ...
            // if (area == "SELF_SERVICE") {            // else if (area == "APPLICATIONS") {            // else if (area == "ADMIN") {            // else if (area == "PACKAGE") {            // else if (area == "REPORT") {
            if (area == "ACQUEON") {
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == "Total" && obj.ProductName == 'ACQUEON';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                    internalcalc.IMPL = SelfServiceRow;
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == "Total" && obj.ProductName == 'SERVION_PRODUCTS';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                    internalcalc.IMPL = SelfServiceRow;
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == "Total" && obj.ProductName == 'Avaya';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                    internalcalc.IMPL = SelfServiceRow;
            ...
            if (area == "eGain") {
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == "Total" && obj.ProductName == 'eGain';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                    internalcalc.IMPL = SelfServiceRow;
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == "Total" && obj.ProductName == 'WFO';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                    internalcalc.IMPL = SelfServiceRow;
                ...
                var result1 = _.filter($scope.CompleteResultsetMulti, function (obj) {
                    return obj.Section == "Total" && obj.ProductName == 'CISCO';
                });
                if (result1.length > 0) {
                    var SelfServiceRow = parseFloat(result1[0].A1Fcol1) + parseFloat(result1[0].A1Fcol2) + parseFloat(result1[0].A1Fcol3);
                    internalcalc.IMPL = SelfServiceRow;
        ...
        function setdata(data) {
            $scope.ViewData = {
                REQ: 0, Design: 0, DevTest: 0, SysTest: 0, IMPL: 0, UAT: 0, PROD: 0, TRAIN: 0, MANUAL: 0, OH: 0, SQA: 0
            };
            $scope.ViewData = {
                REQ: data.REQ, Design: data.Design, DevTest: data.DevTest, SysTest: data.SysTest, IMPL: data.IMPL, UAT: data.UAT, PROD: data.PROD, TRAIN: data.TRAIN, MANUAL: data.MANUAL, OH: data.OH, SQA: data.SQA
            }
        }
        ...
        function validatedataonSAVEPriceData() {
            return true;
        ...
        $scope.IsExitcalled = false;
        $scope.saveasPaymentSheetdiscard = function () {
            $scope.isEditClicked = false;
            $scope.IsExitcalled = true;
            if ($scope.AddPriceSheet(false))
        ...
        function dointernalpercentagecalculation(ApplicationModel) {
            try {
                var EstSDLCDetail = _.filter($scope.SDLCPercentage, function (obj) {
                    return obj.ProductName == ApplicationModel.ProductName;
                });
        ...
        $scope.GetExtendedEfforts = function () {
            ...
            OpportunityRateService.GetAllOPPORTUNITY_RATE().success(function (data) {
                if (data.Error != undefined) {
                    ...
                    $scope.GrossMargins_GRDDATA = _.filter(data, function (obj) {
                        return obj.Rate_Type == "GrossMargins";
                    });
                }
            }).error(function (data) {
        ...
        function setcalculatedeffortsonly() {
            $scope.FixedFTEDaysJson[0].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "REQ"))) : 0;
            $scope.FixedFTEDaysJson[1].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "Design"))) : 0;
            $scope.FixedFTEDaysJson[2].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "DevTest"))) : 0;
            $scope.FixedFTEDaysJson[3].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "SysTest"))) : 0;
            $scope.FixedFTEDaysJson[4].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "IMPL"))) : 0;
            $scope.FixedFTEDaysJson[5].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "UAT"))) : 0;
            $scope.FixedFTEDaysJson[6].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "PROD"))) : 0;
            $scope.FixedFTEDaysJson[7].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "TRAIN"))) : 0;
            $scope.FixedFTEDaysJson[8].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "MANUAL"))) : 0;
            $scope.FixedFTEDaysJson[9].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "OH"))) : 0;
            $scope.FixedFTEDaysJson[10].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "SQA"))) : 0;
            //$scope.FixedFTEDaysJson[11].CalculatedEfforts = $scope.gridCalculatedEffortdata.length > 0 ? (sum(_.pluck($scope.gridCalculatedEffortdata, "PM"))) : 0;
            $scope.gridFTEDays.api.refreshView()
            // $scope.gridFTEDays.api.setRowData($scope.FixedFTEDaysJson);
        }

        function Fourthtabaction() {
            //set column def here immediately
            $scope.FixedFTEDaysJson[0].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "REQ")));
            $scope.FixedFTEDaysJson[0].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "REQ")));
            $scope.FixedFTEDaysJson[0].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "REQ")));
            ...
            $scope.FixedFTEDaysJson[1].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "Design")));
            $scope.FixedFTEDaysJson[1].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "Design")));
            $scope.FixedFTEDaysJson[1].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "Design")));
            ...
            $scope.FixedFTEDaysJson[2].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "DevTest")));
            $scope.FixedFTEDaysJson[2].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "DevTest")));
            $scope.FixedFTEDaysJson[2].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "DevTest")));
            ...
            $scope.FixedFTEDaysJson[3].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "SysTest")));
            $scope.FixedFTEDaysJson[3].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "SysTest")));
            $scope.FixedFTEDaysJson[3].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "SysTest")));
            ...
            $scope.FixedFTEDaysJson[4].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "IMPL")));
            $scope.FixedFTEDaysJson[4].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "IMPL")));
            $scope.FixedFTEDaysJson[4].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "IMPL")));
            ...
            $scope.FixedFTEDaysJson[5].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "UAT")));
            $scope.FixedFTEDaysJson[5].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "UAT")));
            $scope.FixedFTEDaysJson[5].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "UAT")));
            ...
            $scope.FixedFTEDaysJson[6].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "PROD")));
            $scope.FixedFTEDaysJson[6].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "PROD")));
            $scope.FixedFTEDaysJson[6].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "PROD")));
            ...
            $scope.FixedFTEDaysJson[7].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "TRAIN")));
            $scope.FixedFTEDaysJson[7].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "TRAIN")));
            $scope.FixedFTEDaysJson[7].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "TRAIN")));
            ...
            $scope.FixedFTEDaysJson[8].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "MANUAL")));
            $scope.FixedFTEDaysJson[8].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "MANUAL")));
            $scope.FixedFTEDaysJson[8].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "MANUAL")));
            ...
            $scope.FixedFTEDaysJson[9].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "OH")));
            $scope.FixedFTEDaysJson[9].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "OH")));
            $scope.FixedFTEDaysJson[9].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "OH")));
            ...
            $scope.FixedFTEDaysJson[10].Tool = (sum(_.pluck($scope.ExtendedEffortFromTooldata, "SQA")));
            $scope.FixedFTEDaysJson[10].Manual = (sum(_.pluck($scope.gridExtendedEffortManualdata, "SQA")));
            $scope.FixedFTEDaysJson[10].Extend = (sum(_.pluck($scope.gridExtendedEffortAdditionaldata, "SQA")));
        ...
        function getcalculatedEffortgriddata() {
            ...
            $scope.gridCalculatedEffortdata = Defaultonerow;
            $scope.gridCalculatedEffort.api.setRowData($scope.gridCalculatedEffortdata);
        ...
        function getcostpriceingridbyfilter(desc) {
            var data = _.filter($scope.GrossMargins_GRDDATA, function (obj) {
                return obj.mode_type == desc;
            });
        ...
        $scope.changeExtendedEffort = function () {
            $scope.gridExtendedEffortAdditionaldata[0].REQ = (($scope.ExtendedEffortPercentage.REQ * (1 / 100)) * ($scope.ExtendedEffortCycle.REQ - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "REQ")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "REQ")));
            $scope.gridExtendedEffortAdditionaldata[0].Design = (($scope.ExtendedEffortPercentage.Design * (1 / 100)) * ($scope.ExtendedEffortCycle.Design - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "Design")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "Design")));
            $scope.gridExtendedEffortAdditionaldata[0].DevTest = (($scope.ExtendedEffortPercentage.DevTest * (1 / 100)) * ($scope.ExtendedEffortCycle.DevTest - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "DevTest")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "DevTest")));
            $scope.gridExtendedEffortAdditionaldata[0].ST = (($scope.ExtendedEffortPercentage.ST * (1 / 100)) * ($scope.ExtendedEffortCycle.SysTest - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "SysTest")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "SysTest")));
            $scope.gridExtendedEffortAdditionaldata[0].IMPL = (($scope.ExtendedEffortPercentage.IMPL * (1 / 100)) * ($scope.ExtendedEffortCycle.IMPL - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "IMPL")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "IMPL")));
            $scope.gridExtendedEffortAdditionaldata[0].UAT = (($scope.ExtendedEffortPercentage.UAT * (1 / 100)) * ($scope.ExtendedEffortCycle.UAT - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "UAT")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "UAT")));
            $scope.gridExtendedEffortAdditionaldata[0].PROD = (($scope.ExtendedEffortPercentage.PROD * (1 / 100)) * ($scope.ExtendedEffortCycle.PROD - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "PROD")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "PROD")));
            $scope.gridExtendedEffortAdditionaldata[0].TRAIN = (($scope.ExtendedEffortPercentage.Train * (1 / 100)) * ($scope.ExtendedEffortCycle.Train - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "TRAIN")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "TRAIN")));
            $scope.gridExtendedEffortAdditionaldata[0].MANUAL = (($scope.ExtendedEffortPercentage.Manual * (1 / 100)) * ($scope.ExtendedEffortCycle.Manual - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "MANUAL")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "MANUAL")));
            $scope.gridExtendedEffortAdditionaldata[0].OH = (($scope.ExtendedEffortPercentage.OH * (1 / 100)) * ($scope.ExtendedEffortCycle.OH - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "OH")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "OH")));
            $scope.gridExtendedEffortAdditionaldata[0].SQA = (($scope.ExtendedEffortPercentage.SQA * (1 / 100)) * ($scope.ExtendedEffortCycle.SQA - 1)) * (sum(_.pluck($scope.ExtendedEffortFromTooldata, "SQA")) + sum(_.pluck($scope.gridExtendedEffortManualdata, "SQA")));
            $scope.gridExtendedEffortAdditional.rowData = $scope.gridExtendedEffortAdditionaldata;
            $scope.gridExtendedEffortAdditional.api.setRowData($scope.gridExtendedEffortAdditionaldata);
            $timeout(function () {
                $scope.gridExtendedEffortAdditional.api.refreshView();
            });
                ...
                _.each($scope.Versiondata, function (value, key) {
                    if (value["PriceSheetId"] == $scope.GlobalGroupId) {
                        ...
                        if (value["DaySheetVersionJSON"] != "" && value["DaySheetVersionJSON"] != null && value["DaySheetVersionJSON"] != undefined && value["DaySheetVersionJSON"] != 'null') {
                            ...
                            $scope.localversionConfirm = $scope.GlobalVersionsave;
                            ReverseCalc();
                        }
                    }
                });
        ...
        $scope.GetPriceSheetByversion = function (oppid, groupid) {
            ...
            // $scope.GetPriceSheetMappeddataByversion(oppid, groupid); jay
        ...
        $scope.GetPriceSheetMappeddataByversion = function (oppid, groupid) {
            priceService.GetPriceSheetMapbyOppGroup(oppid, groupid).success(function (data) {
                ...
                $scope.OldComment = data[0].Comment;
                // $scope.isEditClicked = data[0].IsEditable;
        ...
        $scope.onLoad_PriceList = function () {
            ...
            var columnDefsPrice = [
                ...
                {
                    headerName: "", hide: true, field: 'IsManual', width: 1
                },
                {
                ...
                {
                    headerName: "Component", field: "Component", editable: $scope.isEditClicked, width: 120, headerTooltip: "Component", cellRenderer: function (params) {
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            headerName: "Year 1", field: "Lyear1", width: 90, columnGroupShow: 'open', editable: $scope.isEditClicked, headerTooltip: "Year1",
                            onCellValueChanged: function (params) {
                                singlecalc(params, 1)
                                $scope.gridOptions_PriceList.api.refreshView();
                            },
                        ...
                        {
                            headerName: "Year 2", field: "Lyear2", columnGroupShow: 'open', width: 90, editable: $scope.isEditClicked, headerTooltip: "Year2",
                            onCellValueChanged: function (params) {
                                singlecalc(params, 2)
                                $scope.gridOptions_PriceList.api.refreshView();
                            },
                        ...
                        {
                            headerName: "Year 3", field: "Lyear3", columnGroupShow: 'open', width: 90, editable: $scope.isEditClicked, headerTooltip: "Year3",
                            onCellValueChanged: function (params) {
                                singlecalc(params, 3)
                                $scope.gridOptions_PriceList.api.refreshView();
                            }, cellStyle: { 'background-color': '#CDCDCD' },
                        ...
                        {
                            headerName: "Year 4", field: "Lyear4", columnGroupShow: 'open', width: 90, editable: $scope.isEditClicked, headerTooltip: "Year4",
                            onCellValueChanged: function (params) {
                                singlecalc(params, 4)
                                $scope.gridOptions_PriceList.api.refreshView();
                            },
                        ...
                        {
                            headerName: "Year 5", field: "Lyear5", columnGroupShow: 'open', width: 90, editable: $scope.isEditClicked, headerTooltip: "Year5",
                            onCellValueChanged: function (params) {
                                singlecalc(params, 5)
                                $scope.gridOptions_PriceList.api.refreshView();
                            },
                ...
                {
                    headerName: 'Vendor Discount %', field: "forvendordiscount", width: 130, editable: $scope.isEditClicked, cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else
                            return '<span title=' + params.value + '>' + params.value + ' </span>';
                ...
                {
                    headerName: 'Distributor Margin %', field: "distmarginpercent", width: 90, editable: $scope.isEditClicked, headerTooltip: "Margin %", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Distributor Discount %', field: "distdiscount", width: 90, editable: $scope.isEditClicked, headerTooltip: "To Customer Discount", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Margin %', field: "marginpercent", width: 90, editable: $scope.isEditClicked, headerTooltip: "Margin %", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else {
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Customer Discount %', field: "customerdiscount", width: 90, editable: $scope.isEditClicked, headerTooltip: "To Customer Discount", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else {
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Duty / TAX 1 %', field: "Dutytax1", width: 100, editable: $scope.isEditClicked, headerTooltip: "Duty / TAX 1 %", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Duty / TAX 2 %', field: "Dutytax2", width: 100, editable: $scope.isEditClicked, headerTooltip: "Duty / TAX 2 %", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Duty / TAX 3 %', field: "Dutytax3", width: 100, editable: $scope.isEditClicked, headerTooltip: "Duty / TAX 3 %", cellRenderer: function (params) {
                        if (params.node.floating != "bottom")
                            return '<span title=' + params.value + '>' + params.value + ' %</span>';
                        else
                            return '<span title=' + params.value + '>' + params.value + '</span>';
                ...
                {
                    headerName: 'Conversion Rate', field: "ConversionRate", width: 100, editable: $scope.isEditClicked, headerTooltip: "Conversion Rate", cellRenderer: function (params) {
                        return '<span title=' + params.value + '>' + params.value + '</span>';
                    }
                    , onCellValueChanged: function (params) {
                        singlecalc(params);
        ...
        $scope.AddPriceSheet = function (issaveas) {
            if (isNaN($scope.GlobalGroupId) || issaveas) {
                priceService.GetMaximumGroupPriceSheetId().success(function (data) {
                    if (data[0].count == 'null') {
                        $scope.MaxSheetGroupIDForSaveAs = 1;
                    }
                    ...
                    if (issaveas) {
                        ...
                        var version = 'Ver_' + i;
                        $scope.MaxVersion_PriceList = version;
                        $scope.IsSaveAs = true;
                    }
                    else {
                        $scope.MaxVersion_PriceList = 'Ver_0.1';
                        $scope.Comment = 'Initial';
                    }
                ...
                $scope.Comment = $scope.OldComment;
                savedataprocess();
            }
        }
        ...
        function savedataprocess() {
            if (validatedataonSAVEPriceData() && validatedataonsavePayment() && ValidateTandEResourceData() && ValidateResourceData() && ValidateTandEPSData() && validatedataonSAVE_pricingsheet()) {
                precleanupprocess();
                var Daysheetdata = $scope.ExtendedEffortFromTooldata.concat($scope.gridExtendedEffortManualdata).concat($scope.gridExtendedEffortAdditionaldata).concat($scope.gridCalculatedEffortdata).concat($scope.dataLOB);
                ...
                var DaysheetJsondata = {
                    OppId: $scope.OpportunityDetail.OppId, IsSaveAs: false, SheetId: $scope.MaxSheetGroupID, Version: $scope.MaxVersion, IsReadOnly: $scope.isEditClicked, DaySheet: Daysheetdata, Authour: $scope.LoggedUser,
                ...
                //site details
                var OppConfigJsondata = { OppId: $scope.OpportunityDetail.OppId, IsSaveAs: false, SheetId: $scope.MaxSheetGroupID, Version: $scope.MaxVersion, IsReadOnly: $scope.grideditable, paymentsheet: $scope.OpportunityDetail, Authour: $scope.LoggedUser };


                //payment
                var paymentlength = $scope.Paymentdata.length;
                for (var j = 0; j < paymentlength; j++) {
                    try {
                        ...
                        $scope.Paymentdata[j].PaymentSheetGroupId = $scope.MaxSheetGroupID;
                    }
                    catch (e) {
                        console.log('some error while sending data to server')
                    }
                ...
                var PaymentJsondata = { OppId: $scope.OpportunityDetail.OppId, IsSaveAs: false, SheetId: $scope.MaxSheetGroupID, Version: $scope.MaxVersion, IsReadOnly: $scope.isEditClicked, paymentsheet: $scope.Paymentdata, Authour: $scope.LoggedUser };
                ...
                var GMJsondata = { OppId: $scope.OpportunityDetail.OppId, IsSaveAs: false, SheetId: $scope.MaxSheetGroupID, Version: $scope.MaxVersion, IsReadOnly: $scope.isEditClicked, paymentsheet: $scope.GrossMargindata, Authour: $scope.LoggedUser };
                ...
                for (var j = 0; j < $scope.data_PriceList.length; j++) {
                    try {
                        ...
                        $scope.data_PriceList[j].PriceSheetGroupId = $scope.MaxSheetGroupID;
                    }
                    catch (e) {
                        console.log('some error while sending data to server')
                    }
                ...
                var PriceSheetJsondata = {
                    OppId: $scope.OpportunityDetail_PriceList.OppId, IsSaveAs: false, PriceSheetId: $scope.MaxSheetGroupID, Version: $scope.MaxVersion_PriceList, IsReadOnly_PriceList: $scope.isEditClicked, ColStatus: constructstr, pricesheet: $scope.data_PriceList, Authour: $scope.LoggedUser,
                    ...
                    IsSaveAs: $scope.IsSaveAs
                };

                priceService.AddPriceSheet(PriceSheetJsondata).success(function (data) {
                    if (data.Error == "" || data.Error == undefined || data.Error == null) {
                        //j     if ($scope.Isleaving)
                        $scope.isEditClicked = false;
                        $('#showSavemodel').modal('hide');
                        if (!$scope.IsExitcalled) {
                            if (PriceSheetJsondata.IsSaveAs || $scope.IsfreshSheet_PriceList)
                                redirectRefreshPage($routeParams.OppId, $scope.MaxSheetGroupID);
                            else
                                postCleanup();
                        }
        ...
        $scope.deleteRow = function () {
            ...
            else if ($scope.data_PriceList[selected.rowIndex].IsManual == 'N') //have to add manual or dynamic
            {
        ...
        $scope.IncreaseAdditionalTimeToSheet = function () {
            var LockSheetModel = { GroupId: $scope.MaxSheetGroupID, username: $scope.LoggedUser, LockedInApp: 'PriceSheet' };
            priceService.IncreaseAdditionalTimeToSheet(LockSheetModel).success(function (data) {
                if (!data.IsLocked) {
                    $scope.hasedit_PriceList = false;
                    $scope.LockStatusMsg = true;
        ...
        $scope.EditSheet = function () {
            ...
            angular.element(document.querySelector('#loader')).removeClass('hide');
            if ($routeParams.GroupId == 'undefined' || $routeParams.GroupId == 'null' || $routeParams.GroupId == "") {
                console.log('Now version completed and increased')
                priceService.GetMaximumGroupPriceSheetId().success(function (data) {
                    $scope.MaxVersion_PriceList = 'Ver_0.1'
                    if (data[0].count == 'null') {
                        ...
                        $scope.MaxSheetGroupID = data[0].count + 1;
                    }
        ...
        function Lockthesheet() {
            var LockSheetModel = { OppId: $scope.OpportunityDetail_PriceList.OppId, GroupId: $scope.MaxSheetGroupID, username: $scope.LoggedUser, LockedInApp: 'PriceSheet', IsPriceSheetUpdated: true };
            priceService.LocktheSheetByGroupid(LockSheetModel).success(function (data) {
                ...
                if (!data.IsLocked) {
                    ...
                    $scope.MaxSheetGroupID = data.PriceSheetId;
                    $scope.MaxVersion_PriceList = data.Version;
                    $scope.isEditClicked = data.IsEditable;
                    $scope.$broadcast('timer-reset');
                    $scope.$broadcast('timer-start');
                }
                else {

                    if (data.LockedUser == $scope.LoggedUser && data.LockedIn == "PriceSheet") {
                        $scope.hasedit_PriceList = false;
                        $scope.LockStatusMsg = true;
                        $scope.isEditClicked = true;
                        $routeParams.GroupId = data.PriceSheetId;
                ...
                $scope.GetOpportunityList($routeParams.OppId, true);
        ...
        function getLOBValue(params) {
            ...
            if (params.data.oem != 'Servion' && params.data.oem != 'Acqueon') {                     //"TRADING"
            ...
            else if (params.data.oem == 'Acqueon') {                                                  //"IP"
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "Software") {       //IP
                var obj = getLOBbyFilter("IP")
                if (obj != null) {
                    params.data.lob = obj.Id;
                    params.data.LOBName = obj.LOBName;
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "AMC-SW") {          //IP
                var obj = getLOBbyFilter("IP")
                if (obj != null) {
                    params.data.lob = obj.Id;
                    params.data.LOBName = obj.LOBName;
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "ServCare") {        //MAINTENANCE
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "Resourcing") {      //RESOURCING
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "Consulting") {         //CONSULTING
            ...
            else if (params.data.oem == 'Servion' && (params.data.componenttype == "PS" || params.data.componenttype == "T&M")) {                //PS
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "Hosted") {                //CONSULTING
            ...
            else if (params.data.oem == 'Servion' && params.data.componenttype == "T&E") {                //CONSULTING
                var obj = getLOBbyFilter("TRADING");
                if (obj != null) {
                    params.data.lob = obj.Id;
                    params.data.LOBName = obj.LOBName;
                ...
                if ($scope.margin.TRADING != 0) {
                    ...
                    if (trade.length > 0) {
                        if ($scope.margin.TRADING <= trade[0].Level1 && $scope.margin.TRADING > trade[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.TRADINGvalue, value2: $scope.margin.TRADING, Type: 'TRADING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.TRADING <= trade[0].Level2 && $scope.margin.TRADING > trade[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.TRADINGvalue, value2: $scope.margin.TRADING, Type: 'TRADING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.TRADING <= trade[0].Level3 && $scope.margin.TRADING > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.TRADINGvalue, value2: $scope.margin.TRADING, Type: 'TRADING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                    }
                }
                ...
                if ($scope.margin.MAINTANACE != 0) {
                    ...
                    if (maintenance.length > 0) {
                        if ($scope.margin.MAINTANACE <= maintenance[0].Level1 && $scope.margin.MAINTANACE > maintenance[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.margin.MAINTANACE, value2: $scope.MAINTANACEvalue, Type: 'MAINTANACE', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.MAINTANACE <= maintenance[0].Level2 && $scope.margin.MAINTANACE > maintenance[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.margin.MAINTANACE, value2: $scope.MAINTANACEvalue, Type: 'MAINTANACE', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.MAINTANACE <= maintenance[0].Level3 && $scope.margin.MAINTANACE > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.margin.MAINTANACE, value2: $scope.MAINTANACEvalue, Type: 'MAINTANACE', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                    }
                }
                ...
                if ($scope.margin.IP != 0) {
                    ...
                    if (ip.length > 0) {
                        if ($scope.margin.IP <= ip[0].Level1 && $scope.margin.IP > ip[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.margin.IP, value2: $scope.IPvalue, Type: 'IP', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.IP <= ip[0].Level2 && $scope.margin.IP > ip[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.margin.IP, value2: $scope.IPvalue, Type: 'IP', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.IP <= ip[0].Level3 && $scope.margin.IP > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.margin.IP, value2: $scope.IPvalue, Type: 'IP', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                    }
                }
                ...
                if ($scope.margin.HOSTED != 0) {
                    ...
                    if (hosted.length > 0) {
                        if ($scope.margin.HOSTED <= hosted[0].Level1 && $scope.margin.HOSTED > hosted[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.margin.HOSTED, value2: $scope.HOSTEDvalue, Type: 'HOSTED', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.HOSTED <= hosted[0].Level2 && $scope.margin.HOSTED > hosted[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.margin.HOSTED, value2: $scope.HOSTEDvalue, Type: 'HOSTED', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.HOSTED <= hosted[0].Level3 && $scope.margin.HOSTED > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.margin.HOSTED, value2: $scope.HOSTEDvalue, Type: 'HOSTED', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                    }
                }
                ...
                if ($scope.margin.PS != 0) {
                    ...
                    if (ps.length > 0) {
                        if ($scope.margin.PS <= ps[0].Level1 && $scope.margin.PS > ps[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.margin.PS, value2: $scope.PSvalue, Type: 'PS', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.PS <= ps[0].Level2 && $scope.margin.PS > ps[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.margin.PS, value2: $scope.PSvalue, Type: 'PS', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.PS <= ps[0].Level3 && $scope.margin.PS > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.margin.PS, value2: $scope.PSvalue, Type: 'PS', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                    }
                }
                ...
                if ($scope.margin.RESOURCING != 0) {
                    ...
                    if (resource.length > 0) {
                        if ($scope.margin.RESOURCING <= resource[0].Level1 && $scope.margin.RESOURCING > resource[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.margin.RESOURCING, value2: $scope.RESOURCINGvalue, Type: 'RESOURCING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName })
                        }
                        else if ($scope.margin.RESOURCING <= resource[0].Level2 && $scope.margin.RESOURCING > resource[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.margin.RESOURCING, value2: $scope.RESOURCINGvalue, Type: 'RESOURCING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName })
                        }
                        else if ($scope.margin.RESOURCING <= resource[0].Level3 && $scope.margin.RESOURCING > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.margin.RESOURCING, value2: $scope.RESOURCINGvalue, Type: 'RESOURCING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName })
                        }
                    }
                }
                ...
                if ($scope.margin.CONSULTING != 0) {
                    ...
                    if (consulting.length > 0) {
                        if ($scope.margin.CONSULTING <= consulting[0].Level1 && $scope.margin.CONSULTING > consulting[0].Level2) {
                            ProjectMArginOjectsLevel1.push({ value1: $scope.margin.CONSULTING, value2: $scope.CONSULTINGvalue, Type: 'CONSULTING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.CONSULTING <= consulting[0].Level2 && $scope.margin.CONSULTING > consulting[0].Level3) {
                            ProjectMArginOjectsLevel2.push({ value1: $scope.margin.CONSULTING, value2: $scope.CONSULTINGvalue, Type: 'CONSULTING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                        else if ($scope.margin.CONSULTING <= consulting[0].Level3 && $scope.margin.CONSULTING > 0) {
                            ProjectMArginOjectsLevel3.push({ value1: $scope.margin.CONSULTING, value2: $scope.CONSULTINGvalue, Type: 'CONSULTING', OppId: $scope.OpportunityDetail.OppId, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName });
                        }
                    }
                }
        ...
        function calculateThreshold() {
            ...
            var JSONMaildata = { EmailMArginOjectsLevel1: EmailMArginOjectsLevel1, EmailMArginOjectsLevel2: EmailMArginOjectsLevel2, EmailMArginOjectsLevel3: EmailMArginOjectsLevel3, EmailDiscountOjectsLevel1: EmailDiscountOjectsLevel1, EmailDiscountOjectsLevel2: EmailDiscountOjectsLevel2, EmailDiscountOjectsLevel3: EmailDiscountOjectsLevel3, OpportunityName: $scope.OpportunityDetail.OpportunityName, AccountName: $scope.OpportunityDetail.AccountName }
        ...
        function addrowforTotalPercentageUtilize(data) {
            ...
            angular.forEach(data, function (value, key) {
                ...
                if (value.PaymentCode != "" && value.PercentageType == 'Yes' && value.PaymentCode != 'S9' && value.PaymentCode != 'S10') {
                    ...
                    Jsondata.SERVResource = parseFloat(Jsondata.SERVResource) + +parseInt(value.SERVResource);
        ...
        $scope.callifAPIDone_Payment = function () {
            if ($scope.call1finished_payment && $scope.call2finished_payment && $scope.call3finished_payment && $scope.call6finished_payment) {
                //price sheet call
                docalculationforpayment();
        ...
        $scope.onLoad_payment = function () {
            ...
            var columnDefs = [
                ...
                {
                    headerName: "Payment Terms(Days)", field: "paymentTerms", width: 120, headerTooltip: "Payment Terms(Days)", editable: $scope.isEditClicked,
                    newValueHandler: function (params) {
                        if (params.newValue == "") {
                            params.newValue = 0;
                        }
        ...
        $scope.InitApiCalls_PayList = function () {
            ...
            $scope.GetOpportunityList($routeParams.OppId, false);
        }
        ...
        $scope.PageVariableInitialization_GM = function () {
            ...
            $scope.hasedit = false;
            $scope.margin = { PS: 0, RESOURCING: 0, MAINTANACE: 0, IP: 0, HOSTED: 0, TRADING: 0, CONSULTING: 0 };
        ...
        function PricesheetFeedToGrossMargin(data) {
            ...
            angular.forEach(data, function (value, key) {
                ...
                if (value.oem == 'Servion' && value.pricetype == 'COST') {
                    $scope.totalPSpricefromPricingMinus += (parseFloat(value.Lyear1) + parseFloat(value.Lyear2) + parseFloat(value.Lyear3) + parseFloat(value.Lyear4) + parseFloat(value.Lyear5));
                }
        ...
        $scope.GetGrossmarginbyOppGroup_GM = function (oppid, groupid) {
            //hard coded for jay
            //$scope.TandEPSData = [];
            TandEPSService.GetAllTandEPSbyOppGroupID($scope.OpportunityDetail.OppId, groupid).success(function (data) {
                if (data.Error == null) {
                    if (data.length > 0)
        ...
        $scope.GetOpportunityListOppConfig = function (oppid, groupid) {
            console.log('oppid, groupid' + oppid + "" + groupid)
        ...
        },
        {
            headerName: "Description", field: "Description", width: 200, pinned: true, cellRenderer: function (params) {
                if (params.data.Description != 'TOTAL') {
                    if ($scope.isEditClicked) {
                        if (params.data.EditDescription)
            ...
            },
            {
                headerName: "Description", field: "Description", width: 200, pinned: true, cellRenderer: function (params) {
                    if (params.data.Description != 'TOTAL') {
                        if ($scope.isEditClicked) {
                            if (params.data.EditDescription)
                                return '<span><input id="resTypeTxt" ng-disabled="false" ng-model="TandEPSData[' + params.rowIndex + '].Description" type="text" />';
                            else
                                return '<span><input style="background-color:white" id="resTypeTxt" ng-disabled="true" ng-model="TandEPSData[' + params.rowIndex + '].Description" type="text" />';
                        }
                        else
                            return '<span><input style="background-color:white" id="resTypeTxt" ng-disabled="true" ng-model="TandEPSData[' + params.rowIndex + '].Description" type="text" />';
                    }
        ...
        var columnDefResource = [
            ...
            },
            {
                headerName: "Unit Rate <br>(Cost)", width: 100, field: "UnitRate", cellRenderer: function (params) {
                    return '<span><input class="unitrate" id="unitRateTxt" ng-disabled="!isEditClicked"'
        ...
        $scope.GetResourceGridData = function () {
            if ($routeParams.GroupId != 'undefined') {
                ...
                ResourceService.GetAllResourcebyOppGroupID($scope.OppDetail.OppId, $scope.MaxSheetGroupID).success(function (data) {
                    if (data.Error == null) {
        ...
        $scope.GetTandEPSGridData = function () {
            try {
                ...
                if ($routeParams.GroupId != 'undefined') {
                    ...
                    DayService.GetDaysheetFTEHoursbyOppGroup($scope.OppId, $scope.MaxSheetGroupID).success(function (inputs) {
                        //if (inputs.length > 0) {
                        TandEPSService.GetAllTandEPSbyOppGroupID($scope.OppDetail.OppId, $scope.MaxSheetGroupID).success(function (data) {
                            if (data.Error == null) {
                                console.log('-------------------------------------Input-----------------------------------------');
                                ...
                                if (data.length == 0) {
                                    if (inputs.length > 0) {
                                        ...
                                        $scope.TandEPSData.push({ RowNo: 1, Description: 'Requirements Gathering', ManDays: inputs[0].ManDays, ResourceCount: parseInt(inputs[0].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[0].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 2, Description: 'Design', ManDays: inputs[1].ManDays, ResourceCount: parseInt(inputs[1].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[1].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 3, Description: 'Development & Test', ManDays: inputs[2].ManDays, ResourceCount: parseInt(inputs[2].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[2].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 4, Description: 'System Testing', ManDays: inputs[3].ManDays, ResourceCount: parseInt(inputs[3].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[3].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 5, Description: 'Implementation', ManDays: inputs[4].ManDays, ResourceCount: parseInt(inputs[4].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[4].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 6, Description: 'UAT', ManDays: inputs[5].ManDays, ResourceCount: parseInt(inputs[5].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[5].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: 'Y', OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 7, Description: 'Production Support / Cutover', ManDays: inputs[6].ManDays, ResourceCount: parseInt(inputs[6].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[6].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: 'Y', OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 8, Description: 'Training', ManDays: inputs[7].ManDays, ResourceCount: parseInt(inputs[7].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[7].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: 'Y', OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        ...
                                        $scope.TandEPSData.push({ RowNo: 10, Description: 'Orientation & Handover', ManDays: inputs[9].ManDays, ResourceCount: parseInt(inputs[9].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[9].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: 'Y', OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 11, Description: 'SQA', ManDays: inputs[10].ManDays, ResourceCount: parseInt(inputs[10].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[10].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 12, Description: 'Project Management', ManDays: inputs[11].ManDays, ResourceCount: parseInt(inputs[11].Resources), ChangeResourceCountTo: "", OnsitePercent: parseInt(inputs[11].OnsitePercentage), ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        // $scope.TandEPSData.push({ RowNo: 13, Description: 'Calculated Efforts', ManDays: 0, ResourceCount: 0, ChangeResourceCountTo: "", OnsitePercent: 0, ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: 'Y', OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 13, Description: 'From Cost Sheet - Resourcing Model', ManDays: 0, ResourceCount: 0, ChangeResourceCountTo: "", OnsitePercent: 0, ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
                                        $scope.TandEPSData.push({ RowNo: 14, Description: 'Other 1', ManDays: 0, ResourceCount: 0, ChangeResourceCountTo: "", OnsitePercent: 0, ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: true });
                                        ...
                                        totalrowPS = [{ RowNo: "", Description: 'TOTAL', ManDays: "", ResourceCount: "", ChangeResourceCountTo: "", OnsitePercent: "", ChangeOnsitePercentTo: "", AvgTravel: "", StaysOnsite: "", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false }];
                                    }
                                    else {
                                        $scope.TandEPSData.push({ RowNo: 1, Description: 'Requirements Gathering', ManDays: 0, ResourceCount: 0, ChangeResourceCountTo: "", OnsitePercent: 0, ChangeOnsitePercentTo: "", AvgTravel: 1, StaysOnsite: "N", OnsiteBusinessDays: 0, EffectiveBusinessDays: 0, TravelManDays: 0, Visa: 0, AirFare: 0, Accomodation: 0, PerDiem: 0, LocalConveyance: 0, Misc: 0, Total: 0, EditDescription: false });
        ...
        $scope.GetTandEResourceGridData = function () {
            if ($routeParams.GroupId != 'undefined') {
                ...
                $scope.TandEResourceData = [];
                totalrowResource = [];
                TandEResourceService.GetAllTandEResourcebyOppGroupID($scope.OppDetail.OppId, $scope.MaxSheetGroupID).success(function (data) {
                    if (data.Error == null) {
        ...
        $scope.ResourceRowChanged = function (change, index) {
            if (change == 'Modify') { //Modified row data
                ...
                var alterrows = index;
                $scope.TandEResourceData.splice(alterrows, 1);
            ...
            if ($scope.margin.RESOURCING != 0) {
                ...
                if (resource.length > 0) {
                    if ($scope.margin.RESOURCING <= resource[0].DefaultVal && $scope.margin.RESOURCING > resource[0].Level1) {
                        ...
                        $scope.ColorValues['RESOURCING'] = "PMLevel3";
                    }
                }
            }
            else
            ...
            if ($scope.margin.CONSULTING != 0) {
                ...
                if (consulting.length > 0) {
                    if ($scope.margin.CONSULTING <= consulting[0].DefaultVal && $scope.margin.CONSULTING > consulting[0].Level1) {
                        $scope.ColorValues['CONSULTING'] = "PMgreat";
                    }
                    else if ($scope.margin.CONSULTING <= consulting[0].Level1 && $scope.margin.CONSULTING > consulting[0].Level2) {
                        $scope.ColorValues['CONSULTING'] = "PMLevel1";
                    }
                    else if ($scope.margin.CONSULTING <= consulting[0].Level2 && $scope.margin.CONSULTING > consulting[0].Level3) {
                        $scope.ColorValues['CONSULTING'] = "PMLevel2";
                    }
                    else if ($scope.margin.CONSULTING <= consulting[0].Level3 && $scope.margin.CONSULTING > 0) {
                        $scope.ColorValues['CONSULTING'] = "PMLevel3";
                    }
                }
            }
            else
        ...
        function addDynamicrowforEstimation() {
        }
        function addDynamicrowforResourcing() {
