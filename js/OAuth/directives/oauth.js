  ...
  function (IdToken, AccessToken, Endpoint, Profile, Storage, OidcConfig, $location, $rootScope, $compile, $http, $templateCache, $timeout) {
    ...
    var definition = {
      ...
      scope: {
        ...
        resource: '@',       // (optional) resource relying party trust
    ...
    definition.link = function postLink(scope, element) {
      ...
      var initAttributes = function () {
        ...
        scope.template = scope.template || 'js/views/templates/default.html';
        scope.responseType = scope.responseType || 'token';
        scope.text = scope.text || 'Click here to directly access PricingTool with your Windows credentials ';
